 ...
 */
final class Version20201204223218 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE school (id INT AUTO_INCREMENT NOT NULL, nomref VARCHAR(255) NOT NULL, prenomref VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, schoolname VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, nbrestudent VARCHAR(255) NOT NULL, message TINYTEXT NOT NULL, classe VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
